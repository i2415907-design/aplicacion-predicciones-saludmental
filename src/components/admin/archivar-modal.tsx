      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-5" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-gray-900">Archivar Caso #{encuestaId}</h3>
          </div>
        ...
        {casosExistentes.length > 0 && (
          <div className="mb-4 space-y-2">
            <p className="text-xs text-gray-500 uppercase font-medium">Ya archivado en:</p>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 text-sm border rounded-lg mb-3 resize-none"
          rows={2}
        />
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg border text-sm text-left transition-colors ${
                  already ? 'bg-gray-50 text-gray-400 cursor-not-allowed border-gray-100' : 'hover:bg-purple-50 hover:border-purple-200 border-gray-200'
                }`}
              >
