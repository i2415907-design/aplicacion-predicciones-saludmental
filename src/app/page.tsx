    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Encuesta Clínica</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Dashboard BI</h2>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Chat con IA</h2>
          <p className="text-gray-600 mb-4">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border">
        <h3 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué este sistema?</h3>
