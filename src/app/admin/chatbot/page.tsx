...
export default function AdminChatbotPage() {
  ...
  const getRiesgoColor = (riesgo: string) => {
    switch (riesgo) {
      case 'muy_alto': return 'bg-red-100 text-red-700'
    ...
    <div className="h-[calc(100vh-200px)] flex gap-4">
      ...
      <div className="w-80 bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col">
        <div className="p-4 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-1">Selecciona para contexto</p>
        </div>
        <div className="flex-1 overflow-y-auto p-2 space-y-2">
          {notificaciones.length === 0 ? (
            <p className="text-sm text-gray-500 text-center py-4">No hay notificaciones pendientes</p>
          ) : (
        ...
        <div className="p-4 border-b border-gray-100">
          ...
          {selectedNotif && (
            <div className="mt-2 p-2 bg-purple-50 rounded-lg text-sm">
              <p className="font-medium text-purple-800">Contexto: {selectedNotif.titulo}</p>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-end gap-2">
            <textarea
              ...
              className="flex-1 resize-none px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              rows={2}
            />
            <button
              onClick={handleSend}
