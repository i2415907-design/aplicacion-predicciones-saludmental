...
\restrict UYv8781uf73MSx91aPNvjDYDhv0FKqSTsZjxFoVYVCfuDd5m18t16gnXtmhP9CT

-- Dumped from database version 17.6
-- Dumped by pg_dump version 18.6

-- Started on 2026-08-15 19:26:19
...
--
-- TOC entry 17 (class 2615 OID 17589)
...
--
-- TOC entry 305 (class 1259 OID 17837)
-- Name: casos_archivados; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.casos_archivados (
    id integer NOT NULL,
    encuesta_id integer NOT NULL,
    categoria_id integer NOT NULL,
    notas text,
    archivado_por character varying(191),
    fecha_archivo timestamp with time zone DEFAULT now()
);


ALTER TABLE public.casos_archivados OWNER TO postgres;

--
-- TOC entry 304 (class 1259 OID 17836)
-- Name: casos_archivados_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.casos_archivados_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.casos_archivados_id_seq OWNER TO postgres;

--
-- TOC entry 3925 (class 0 OID 0)
-- Dependencies: 304
-- Name: casos_archivados_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.casos_archivados_id_seq OWNED BY public.casos_archivados.id;


--
-- TOC entry 303 (class 1259 OID 17825)
-- Name: categorias_casos; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.categorias_casos (
    id integer NOT NULL,
    nombre character varying(100) NOT NULL,
    descripcion character varying(255),
    color character varying(7) DEFAULT '#6B7280'::character varying,
    icono character varying(50) DEFAULT 'folder'::character varying,
    created_at timestamp with time zone DEFAULT now()
);


ALTER TABLE public.categorias_casos OWNER TO postgres;

--
-- TOC entry 302 (class 1259 OID 17824)
-- Name: categorias_casos_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.categorias_casos_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.categorias_casos_id_seq OWNER TO postgres;

--
-- TOC entry 3926 (class 0 OID 0)
-- Dependencies: 302
-- Name: categorias_casos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.categorias_casos_id_seq OWNED BY public.categorias_casos.id;
...
CREATE TABLE public.encuestas (
    ...
    CONSTRAINT chk_satisfaccion_range CHECK (((satisfaccion IS NULL) OR ((satisfaccion >= 1) AND (satisfaccion <= 5))))
);
...
-- Dependencies: 285
-- Name: COLUMN encuestas.satisfaccion; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.encuestas.satisfaccion IS 'Satisfacción del usuario con la evaluación (1-5). NULL si no respondió.';
...
--
-- TOC entry 307 (class 1259 OID 25369)
-- Name: sesiones_encuesta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sesiones_encuesta OWNER TO postgres;

--
-- TOC entry 3940 (class 0 OID 0)
-- Dependencies: 307
-- Name: TABLE sesiones_encuesta; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.sesiones_encuesta IS 'Rastrea cada intento de encuesta para métricas de validación (completion rate, tiempo, pasos)';


--
-- TOC entry 306 (class 1259 OID 25368)
-- Name: sesiones_encuesta_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.sesiones_encuesta_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.sesiones_encuesta_id_seq OWNER TO postgres;

--
-- TOC entry 3941 (class 0 OID 0)
-- Dependencies: 306
-- Name: sesiones_encuesta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.sesiones_encuesta_id_seq OWNED BY public.sesiones_encuesta.id;
...
--
-- TOC entry 3625 (class 2604 OID 17594)
...
--
-- TOC entry 3629 (class 2604 OID 17604)
...
--
-- TOC entry 3727 (class 2604 OID 17840)
-- Name: casos_archivados id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.casos_archivados ALTER COLUMN id SET DEFAULT nextval('public.casos_archivados_id_seq'::regclass);


--
-- TOC entry 3723 (class 2604 OID 17828)
-- Name: categorias_casos id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.categorias_casos ALTER COLUMN id SET DEFAULT nextval('public.categorias_casos_id_seq'::regclass);


--
-- TOC entry 3632 (class 2604 OID 17611)
...
--
-- TOC entry 3634 (class 2604 OID 17619)
...
--
-- TOC entry 3639 (class 2604 OID 17628)
...
--
-- TOC entry 3650 (class 2604 OID 17643)
...
--
-- TOC entry 3654 (class 2604 OID 17651)
...
--
-- TOC entry 3667 (class 2604 OID 17672)
...
--
-- TOC entry 3680 (class 2604 OID 17689)
...
--
-- TOC entry 3686 (class 2604 OID 17701)
...
--
-- TOC entry 3694 (class 2604 OID 17713)
...
--
-- TOC entry 3701 (class 2604 OID 17726)
...
--
-- TOC entry 3704 (class 2604 OID 17733)
...
--
-- TOC entry 3705 (class 2604 OID 17738)
...
--
-- TOC entry 3729 (class 2604 OID 25372)
-- Name: sesiones_encuesta id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sesiones_encuesta ALTER COLUMN id SET DEFAULT nextval('public.sesiones_encuesta_id_seq'::regclass);


--
-- TOC entry 3720 (class 2604 OID 17759)
...
--
-- TOC entry 3742 (class 2606 OID 17847)
-- Name: casos_archivados casos_archivados_encuesta_id_categoria_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.casos_archivados
    ADD CONSTRAINT casos_archivados_encuesta_id_categoria_id_key UNIQUE (encuesta_id, categoria_id);


--
-- TOC entry 3744 (class 2606 OID 17845)
-- Name: casos_archivados casos_archivados_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.casos_archivados
    ADD CONSTRAINT casos_archivados_pkey PRIMARY KEY (id);


--
-- TOC entry 3738 (class 2606 OID 17835)
-- Name: categorias_casos categorias_casos_nombre_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.categorias_casos
    ADD CONSTRAINT categorias_casos_nombre_key UNIQUE (nombre);


--
-- TOC entry 3740 (class 2606 OID 17833)
-- Name: categorias_casos categorias_casos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.categorias_casos
    ADD CONSTRAINT categorias_casos_pkey PRIMARY KEY (id);


--
-- TOC entry 3736 (class 2606 OID 17823)
...
--
-- TOC entry 3750 (class 2606 OID 25380)
-- Name: sesiones_encuesta sesiones_encuesta_encuesta_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sesiones_encuesta
    ADD CONSTRAINT sesiones_encuesta_encuesta_id_key UNIQUE (encuesta_id);


--
-- TOC entry 3752 (class 2606 OID 25378)
-- Name: sesiones_encuesta sesiones_encuesta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sesiones_encuesta
    ADD CONSTRAINT sesiones_encuesta_pkey PRIMARY KEY (id);


--
-- TOC entry 3745 (class 1259 OID 17859)
-- Name: idx_casos_archivados_categoria; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_casos_archivados_categoria ON public.casos_archivados USING btree (categoria_id);


--
-- TOC entry 3746 (class 1259 OID 17858)
-- Name: idx_casos_archivados_encuesta; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_casos_archivados_encuesta ON public.casos_archivados USING btree (encuesta_id);


--
-- TOC entry 3747 (class 1259 OID 25386)
-- Name: idx_sesiones_encuesta_completada; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sesiones_encuesta_completada ON public.sesiones_encuesta USING btree (completada);


--
-- TOC entry 3748 (class 1259 OID 25387)
-- Name: idx_sesiones_encuesta_inicio_en; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sesiones_encuesta_inicio_en ON public.sesiones_encuesta USING btree (inicio_en);


--
-- TOC entry 3753 (class 2606 OID 17853)
-- Name: casos_archivados casos_archivados_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.casos_archivados
    ADD CONSTRAINT casos_archivados_categoria_id_fkey FOREIGN KEY (categoria_id) REFERENCES public.categorias_casos(id) ON DELETE CASCADE;


--
-- TOC entry 3754 (class 2606 OID 17848)
-- Name: casos_archivados casos_archivados_encuesta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.casos_archivados
    ADD CONSTRAINT casos_archivados_encuesta_id_fkey FOREIGN KEY (encuesta_id) REFERENCES public.encuestas(id) ON DELETE CASCADE;


--
-- TOC entry 3755 (class 2606 OID 25381)
-- Name: sesiones_encuesta fk_sesiones_encuesta_encuesta; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sesiones_encuesta
    ADD CONSTRAINT fk_sesiones_encuesta_encuesta FOREIGN KEY (encuesta_id) REFERENCES public.encuestas(id) ON DELETE SET NULL;


--
-- TOC entry 3912 (class 3256 OID 17865)
-- Name: casos_archivados anon_read casos; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "anon_read casos" ON public.casos_archivados FOR SELECT USING ((auth.role() = 'anon'::text));


--
-- TOC entry 3911 (class 3256 OID 17864)
-- Name: categorias_casos anon_read categorias; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "anon_read categorias" ON public.categorias_casos FOR SELECT USING ((auth.role() = 'anon'::text));


--
-- TOC entry 3915 (class 3256 OID 25390)
-- Name: sesiones_encuesta anon_read sesiones; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "anon_read sesiones" ON public.sesiones_encuesta FOR SELECT USING ((auth.role() = 'anon'::text));


--
-- TOC entry 3910 (class 3256 OID 17863)
-- Name: casos_archivados authenticated_read casos; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated_read casos" ON public.casos_archivados FOR SELECT USING ((auth.role() = 'authenticated'::text));


--
-- TOC entry 3909 (class 3256 OID 17862)
-- Name: categorias_casos authenticated_read categorias; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated_read categorias" ON public.categorias_casos FOR SELECT USING ((auth.role() = 'authenticated'::text));


--
-- TOC entry 3914 (class 3256 OID 25389)
-- Name: sesiones_encuesta authenticated_read sesiones; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "authenticated_read sesiones" ON public.sesiones_encuesta FOR SELECT USING ((auth.role() = 'authenticated'::text));


--
-- TOC entry 3905 (class 0 OID 17837)
-- Dependencies: 305
-- Name: casos_archivados; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.casos_archivados ENABLE ROW LEVEL SECURITY;

--
-- TOC entry 3904 (class 0 OID 17825)
-- Dependencies: 303
-- Name: categorias_casos; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.categorias_casos ENABLE ROW LEVEL SECURITY;

--
-- TOC entry 3908 (class 3256 OID 17861)
-- Name: casos_archivados service_role_full_access casos; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role_full_access casos" ON public.casos_archivados USING ((auth.role() = 'service_role'::text));


--
-- TOC entry 3907 (class 3256 OID 17860)
-- Name: categorias_casos service_role_full_access categorias; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role_full_access categorias" ON public.categorias_casos USING ((auth.role() = 'service_role'::text));


--
-- TOC entry 3913 (class 3256 OID 25388)
-- Name: sesiones_encuesta service_role_full_access sesiones; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "service_role_full_access sesiones" ON public.sesiones_encuesta USING ((auth.role() = 'service_role'::text));


--
-- TOC entry 3906 (class 0 OID 25369)
-- Dependencies: 307
-- Name: sesiones_encuesta; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
-- Completed on 2026-08-15 19:26:29

--
-- PostgreSQL database dump complete
--

\unrestrict UYv8781uf73MSx91aPNvjDYDhv0FKqSTsZjxFoVYVCfuDd5m18t16gnXtmhP9CT
